...
\begin{frame}[plain]
    ...
    \end{figure}
    \mynote{P: short repolarization}
    \mynote{Q: repolarization before heartbeat}
    \mynote{R: big contraction that actually pumps blood}
    \mynote{S: section after heartbeat}
    \mynote{T: big repolarization; this is where ischaemia is}
    \mynote{U: not always present}
    \mynote{P: short repolarization}
\end{frame}
