...
\begin{frame}{Introduction}
    \begin{itemize}
        ...
        \item long ECGs are problematic even for computers $\rightarrow$
            simplification through representation
            \mynote{computers and programs can be faster and more accurate than
            humans}
        \item such representations should be simple, but still correspond to
            the original data
    \end{itemize}
\end{frame}
...
\begin{frame}{Research Questions \& Hypothesis}
    \begin{itemize}
        ...
        \item HOT MSAX should have higher recall than HOT SAX if both use their 
            best parameters
    \end{itemize}
\end{frame}
