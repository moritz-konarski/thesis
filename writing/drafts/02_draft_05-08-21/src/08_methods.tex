...
\begin{table}[t]
    ...
    \begin{tabular}{|>{\columncolor{tablegray}}c | r | r | r | r | r |}\hline
        ...
        c & 0.589   & 0        &0        &0        &0.59  \\\hline 
        d & 1.09    & 0.51     &0        &0        &0     \\\hline 
        e & 1.68    & 1.09     &0.59     &0        &0     \\\hline 
    \end{tabular}
\end{table}
For example, if $a=5$, the $\text{MINDIST}$ between ``a" and ``a" is 0, just 
...
SAX distance function $\text{MINDIST}$ is used. Then, a certain window size is
...
The authors find that HOT SAX can effectively detect time series discords and
