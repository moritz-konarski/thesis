...
add discords and non-discords
Research Question:
does the use of the MSAX representation improve the recall of  
the HOT SAX anomaly detection algorithm applied to ECGs compared to the SAX     
representation? What are the optimal parameters for the algorithm?

Hypothesis:
HOT MSAX will have higher recall than HOT SAX because MSAX explicitly
incorporates the multivariate nature of the ECG data.
