...
Research Question:
does the use of the MSAX representation improve the performance of  
the HOT SAX anomaly detection algorithm applied to ECGs compared to the SAX     
representation? 

Hypothesis:
Based on the findings of Anacleto et al, it can be assumed that dual SAX and
MSAX will perform similarly.
The performance of the algorithm will be measured based on its
ability to correctly identify discords in multivariate ECG time series.
