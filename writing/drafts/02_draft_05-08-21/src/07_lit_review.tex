...
series data sets. For these multivariate data sets, SAX was applied to each of
...
to classification accuracy. In 6 of the 14 tested data sets, SAX was
...
noted that in the ECG data set they tested, the accuracy of SAX
...
\TODO{add a list of the leads and where they are}
...
of the MIT-BIH data base \mycite{moody2001,goldberger2000} (for more 
information on the data base, see section \TODO{refer to the ECG data base 
section}).
...
\begin{figure}[t]
    ...
    data points 2031--2390 of recording 103 of the MIT-BIH data base 
...
trainees \mycite{alghatrif2012,xie2020}. 

\TODO{inset some stuff on arrhythmia and ihd, insert stuff from first lit
review on ecg methods.}
