...
\TODO{talking about outliers, make sure to mention how they are below}
...
\begin{table}[H]
    ...
    \end{tabular}
\end{table}
\TODO{don't use see $w$, just put the data there}
...
\end{figure}
\TODO{fix the order of the methods to reflect the order they were analyzed in}
\begin{table}[H]
    \centering
