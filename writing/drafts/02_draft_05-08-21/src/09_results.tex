...
here, they will now be compared with each other. \tabref{09:tab:opt-param}
...
\figref{09:fig:opt_boxplot} are summarized in \tabref{09:tab:opt-param}.
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{recall_boxplot}
    \caption{Boxplot showing the recall for the optimal parameter sets of each
    method. The full list of parameters can be found in \tabref{09:b:opt-param}.}
...
\begin{table}[h]
    ...
    \end{tabular}
\end{table}
\tabref{09:tab:opt-param} shows that D-SAX has the best IQR, S-SAX has the
