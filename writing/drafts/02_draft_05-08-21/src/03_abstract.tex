...
The electrocardiogram (ECG) is the most common diagnostic tool used for heart
...
common. One proposed solution to this problem is computerized ECG analysis
...
store and compare two ECGs. The Symbolic Aggregate Approximation (SAX) is
a prominent representation method that has been modified to properly
