file_name <- "./data/no_sub-single_sax.csv"
save_name <- "./data/no_sub-single_sax-summary_sax.csv"
use_msax <- F
...
# 
# c1 <- data$k == -1 & data$paa_segment_count == 180 & data$subsequence_length == 180 & data$alphabet_size == 24
# c2 <- data$k == -1 & data$paa_segment_count == 180 & data$subsequence_length == 180 & data$alphabet_size == 25
# c3 <- data$k == -1 & data$paa_segment_count == 360 & data$subsequence_length == 360 & data$alphabet_size == 24
# c4 <- data$k == -1 & data$paa_segment_count == 360 & data$subsequence_length == 360 & data$alphabet_size == 25
# c5 <- data$k == -1 & data$paa_segment_count == 120 & data$subsequence_length == 120 & data$alphabet_size == 25
# 
# plot_data <- data[c1 | c2 | c3 | c4 | c5, ]
# p1 <- data[c1, ]
# d <- cbind(rep(1, 48), p1$recall)
# p2 <- data[c2, ]
# d <- rbind(d, cbind(rep(2, 48), p2$recall))
# p3 <- data[c3, ]
# d <- rbind(d, cbind(rep(3, 48), p3$recall))
# p4 <- data[c4, ]
# d <- rbind(d, cbind(rep(4, 48), p4$recall))
# p5 <- data[c5, ]
# d <- rbind(d, cbind(rep(5, 48), p5$recall))
# 
